...
test('buildQualityRowViews: convergence — bridgeContributors lists non-primary bridge candidates', () => {
  ...
  assert.equal(loincView.bridgeContributors[0].candidate.id, 'bridge')
  assert.equal(loincView.bridgeContributors[0].candidate.score, 0.92)
  assert.equal(loincView.bridgeContributors[0].conceptRow.rerank_score, 91)
